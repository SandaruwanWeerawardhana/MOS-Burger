...
function addCart(index) {
  ...
  const existingItem = CartArray.find(item => item.Code === selectItem.itemCode);
...
function displayCart() {
  const AddCart = document.getElementById("cartbox");
  let TempAddCart = ``;
...
//   // Update PlacedTable
//   const PlacedTable = document.getElementById("PlacedTable");
//   let orderHTML = "";

//   Oderarray.forEach((order, orderIndex) => {
...
//           <td>${el.qty}</td>
//           <td>${el.Discount}</td>
//           <td>Rs.${(el.Total).toFixed(2)}</td>
//         </tr>
//       `;
//     });

//   PlacedTable.innerHTML = orderHTML;
...
//       document.getElementById("ItemName").value = element.itemCodel;
